              ...
              {demandes.map(demande => (
                ...
                >
                  ...
                  <td className="px-4 py-3" onClick={e => e.stopPropagation()}>
                    ...
                    {demande.statut === "CREEE" && user?.role === "TECHNICIEN" && (
                      <button
                    ...
                    {demande.statut === "VALIDEE" && user?.role === "TECHNICIEN" && (
                      <button
                    ...
                    {demande.statut === "EN_INTERPRETATION" && (user?.role === "TECHNICIEN" || user?.role === "CHEF_SERVICE") && (
                      <button
                        onClick={async (e) => {
                          e.stopPropagation()
                          try {
